...
const CardsViewBox = ({
  ...
  return (
    <div
      className={` w-full min-w-full rounded-md flex items-center gap-3 p-3 cursor-pointer hover:bg-[#202024] ${className} md:min-w-full md:max-w-full`}
    >
